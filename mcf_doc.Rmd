...
## What percentages of MCF document were jointly issued? 

```{r}
mcf_distinct <- mcf_docs_raw %>%
  distinct(index, title, entity)

mcf_docs_raw %>% anti_join(mcf_distinct, by = c("entity"))
